...
// Value should be part of defaults but is not.=> $6=0 (probe pin invert, bool)
  // Grbl generic default settings. Should work across different machines.
  ...
  #define DEFAULT_Z_ACCELERATION 400 // 10*60*60 mm/min^2 = 10 mm/sec^2
  ...
  #define DEFAULT_STATUS_REPORT_MASK 255
  #define DEFAULT_JUNCTION_DEVIATION 0.02 // mm
  #define DEFAULT_ARC_TOLERANCE 0.010 // mm
